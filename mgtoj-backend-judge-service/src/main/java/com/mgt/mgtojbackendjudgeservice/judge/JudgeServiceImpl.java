...
import com.mgt.mgtojbackendjudgeservice.judge.codesandbox.CodeSandbox;
import com.mgt.mgtojbackendjudgeservice.judge.codesandbox.CodeSandboxFactory;
import com.mgt.mgtojbackendjudgeservice.judge.codesandbox.CodeSandboxProxy;
...
import com.mgt.mgtojbackendserviceclient.service.QuestionFeignClient;
...
public class JudgeServiceImpl implements JudgeService {
    ...
    public QuestionSubmit doJudge(long questionSubmitId) {
        ...
        questionFeignClient.updateQuestionById(questionUpdate);
        if (!update) {
            throw new BusinessException(ErrorCode.SYSTEM_ERROR, "题目状态更新错误");
        }
